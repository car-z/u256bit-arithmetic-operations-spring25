/*
 * Header file declaring functions which operate on uint256
 * CSF Assignment 1
 * Miranda Qing
 * mqing2@jhu.edu
 * Caroline Zhao
...
/*
 * helper function to print every bit (in binary) of 
 * UInt256, comma separated by every 32 values
 * 
 * Parameters:
 *   val - UInt256 number to be printed
 *
 * Returns:
 *   nothing
 */
